					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
                                    <{if 'roleAdd'|check_priv}>    
									<div class="btn-group">

										<a href="<{site_url uri=$backendDir|cat:'/role/add'}>" id="sample_editable_1_new" class="btn green">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-480"><{$v.role_code}></td>
                                              
											<td >
                                                <{if 'assignPriv'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/permission/assignPriv/role/'|cat:$v.id}>" title="分派权限">
                                                    <img src="<{$image_path}>icon_priv.gif" alt="分派权限" />
                                                </a>
                                                <{/if}>
                                                <{if 'roleEdit'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/role/edit/'|cat:$v.id}>" title="修改">
                                                    <img src="<{$image_path}>icon_edit.gif" alt="修改" />
                                                </a>
                                                <{/if}>
                                                <{if 'roleDel'|check_priv}>
                                                <a class=" confirm_opener" href="<{site_url uri=$backendDir|cat:'/role/delete?id='|cat:$v.id}>" title="删除">
