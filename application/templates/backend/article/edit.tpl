								...
								<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Require" msg="文章标题必须填写" id="title" name="title" value="<{$editData.title|urldecode}>" type="text" placeholder="文章标题" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Number" msg="台数必须为正整数" id="deal_num" name="deal_num" value="<{$editData.deal_num}>" type="text" placeholder="成交台数" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Integer" msg="数量必须为整数" id="praise" name="praise" value="<{$editData.praise}>" type="text" placeholder="喜欢数量" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Integer" msg="数量必须为整数" id="derogatory" name="derogatory" value="<{$editData.derogatory}>" type="text" placeholder="没劲数量" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<div class="input-append date date-picker" >
												...
												<input dataType="Require" msg="发布时间必须填写" class="m-wrap m-ctrl-medium date-picker" id="issue_time" name="issue_time" readonly size="16" type="text" value="<{$editData.issue_time|date_format:'%Y-%m-%d'}>" placeholder="发布时间" /><span class="add-on" ><i class="icon-calendar"></i></span>
											...
											<div class="controls">
												...
												<div class="fileupload fileupload-new" data-provides="fileupload">
													...
													<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
														...
														<img src="<{if $editData.main_picture}><{base_url uri=$editData.main_picture}><{else}><{$image_path}>backend/nopic.jpg<{/if}>" alt="" />
									...
									<div class="control-group last">
										...
										<div class="controls">
											...
											<{$ckeditor->editor('content' ,$editData.content|urldecode)}>
