									...
									<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data" >
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="number" name="number" value="" dataType="Require" msg="团购期号必须填写" type="text" placeholder="本期团购期号" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="groupon_name" name="groupon_name" value="" dataType="Require" msg="团购主题必须填写" type="text" placeholder="本期团购主题" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-append date date-picker" >
													...
													<input class="m-wrap m-ctrl-medium date-picker" id="start_time" name="start_time" readonly size="16" type="text" value="" placeholder="开始时间"/><span class="add-on" ><i class="icon-calendar"></i></span>

												</div>
												<span class="help-inline">&nbsp;&nbsp; 至 &nbsp;&nbsp;</span>
												<div class="input-append date date-picker" >

													<input class="m-wrap m-ctrl-medium date-picker" id="end_time" name="end_time" readonly size="16" type="text" value="" dataType="Require" msg="有效期必须填写完整"  placeholder="结束时间" /><span class="add-on" ><i class="icon-calendar"></i></span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="policy" name="policy" value="" dataType="Require" msg="团购政策必须填写" type="text" placeholder="厂家团购政策" class="m-wrap span6" />
