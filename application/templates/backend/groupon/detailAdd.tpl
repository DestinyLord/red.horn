					...
					<div class="portlet box blue ">
						...
						<div class="portlet-body form">
							...
							<form id="data-form" name="infoform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data" >
								...
								<input type="hidden" name="main_id" value="<{$mainInfo.id}>" />
								<div class="tabbable tabbable-custom boxless">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="tab_1">
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="m-wrap span6"><{$mainInfo.number}></span>
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="m-wrap span6"><{$mainInfo.groupon_name|urldecode}></span>
													<div class="clearfix"></div>
												</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="m-wrap span6"><{$mainInfo.start_time|date_format:"%Y年%m月%d日"}> &nbsp;至&nbsp; <{$mainInfo.end_time|date_format:"%Y年%m月%d日"}></span>
													<div class="clearfix"></div>
												</div>
												...
												<div class="controls">
													...
													<div class="row-fluid">
														...
														<div class="span3">
															...
															<input type="radio" name="join_date[]" value="<{($mainInfo.end_time-86400)|date_format:"%Y-%m-%d"}>" /> 本周六（<{($mainInfo.end_time-86400)|date_format:"%m月%d日"}>）
														...
														<div class="span3">
															...
															<input type="radio" name="join_date[]" value="<{($mainInfo.end_time)|date_format:"%Y-%m-%d"}>" /> 本周日（<{($mainInfo.end_time)|date_format:"%m月%d日"}>）
											...
											<div class="control-group policyBox">
												...
												<div class="controls">
													<input id="favorable" name="favorable[]" value="" type="text" placeholder="优惠政策10个字以内" class="m-wrap span6" />
													<div class="clearfix"></div><br/>
													<input name="favorable[]" value="" type="text" placeholder="优惠政策10个字以内" class="m-wrap span6" />
													<div class="clearfix"></div><br/>
													<input name="favorable[]" value="" type="text" placeholder="优惠政策10个字以内" class="m-wrap span6" />
										...
										<div class="tab-pane " id="tab_2">
											<{$ckeditor->editor('flow')}>
										</div>

										<div class="tab-pane " id="tab_3">
											<{$ckeditor->editor('policy')}>
										</div>

										<div class="tab-pane uploads-box" id="tab_4">
											
											<iframe width="100%" height="400" src="<{site_url uri=$backendDir|cat:'/uploadFile/uploadTemplate/grouponDetail'}>" frameborder="0"></iframe>
										</div>
									</div>
								</div>
