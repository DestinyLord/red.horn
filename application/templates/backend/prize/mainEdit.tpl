									...
									<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data" >
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="title" name="title" value="<{$editData.title}>" dataType="Require" msg="活动主题必须填写" type="text" placeholder="活动主题" class="m-wrap span6" />
										...
										<div class="control-group ">
											...
											<div class="controls">
												...
												<div class="basic-toggle-button status-box">
													...
													<input type="checkbox" class="toggle" name="status" value="1" <{if $editData.status == 1}>checked="checked"<{/if}> />
										...
										<div class="control-group ">
											...
											<div class="controls">
												...
												<div class="basic-toggle-button enable-box">
													...
													<input type="checkbox" class="toggle" name="is_enable" value="1" <{if $editData.is_enable == 1}>checked="checked"<{/if}> />
											...
											<div class="controls">
												...
												<div class="fileupload fileupload-new" data-provides="fileupload">
													...
													<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
														...
														<img src="<{if $editData.pic}>/<{$editData.pic}><{else}><{$image_path}>backend/nopic.jpg<{/if}>" alt="" />
