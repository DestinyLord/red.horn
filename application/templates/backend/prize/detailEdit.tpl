									...
									<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data" >
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="name" name="name" value="<{$editData.name}>" dataType="Require" msg="奖品名称必须填写" type="text" placeholder="奖品名称" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="totality" name="totality" value="<{$editData.totality}>" dataType="Number" msg="总量必须为正整数" type="text" placeholder="总量" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="rest" name="rest" value="<{$editData.rest}>" dataType="Number" msg="总量必须为正整数" type="text" placeholder="剩余数量" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="daily_limit" name="daily_limit" value="<{$editData.daily_limit}>" dataType="Number" msg="每日上限必须为整数" type="text" placeholder="每日上限" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="rate" name="rate" value="<{$editData.rate}>" dataType="Double" msg="概率必须为浮点数" type="text" placeholder="概率" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-append date date-picker" >
													...
													<input class="m-wrap m-ctrl-medium date-picker" id="begin_time" name="begin_time" readonly size="16" type="text" value="<{$editData.begin_time|date_format:'%Y-%m-%d'}>"/><span class="add-on" ><i class="icon-calendar"></i></span>

												</div>
												<span class="help-inline">&nbsp;&nbsp; 至 &nbsp;&nbsp;</span>
												<div class="input-append date date-picker" >

													<input class="m-wrap m-ctrl-medium date-picker" id="end_time" name="end_time" readonly size="16" type="text" value="<{$editData.end_time|date_format:'%Y-%m-%d'}>" dataType="Require" msg="有效期必须填写完整"  /><span class="add-on" ><i class="icon-calendar"></i></span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="sort" name="sort" value="<{$editData.sort}>" dataType="Integer" msg="排序必须为整数" type="text" placeholder="奖项排序" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input id="module" name="module" value="<{$editData.module}>" dataType="Require" msg="抽奖模块位置必须填写" type="text" placeholder="奖品名称" class="m-wrap span6" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<select multiple="multiple" id="my_multi_select1" name="leads_key[]">
													...
													<option value="<{$v.leads_key}>" <{if in_array($v.leads_key ,$editData.leadsKeyList)}>selected="true"<{/if}>><{$v.leads_name}></option>
