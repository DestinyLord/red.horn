											...
											<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form">
													...
													<div class="controls">
														...
														<div class="select2-wrapper">
															...
															<select name="channel_id" class="span3 select2_category" tabindex="1">
																...
																<option value="<{$cha.channel_id}>"><{$cha.channel_name}></option>
																<{/foreach}>
		                                        ...
		                                        <div class="control-group">
													...
													<div class="controls">
														...
														<input dataType="Number" msg="长度必须为正整数" id="width" name="width" value="" type="text" placeholder="长度" class="m-wrap span1" />
														&nbsp;&nbsp;*&nbsp;&nbsp;

														<input dataType="Number" msg="宽度必须为正整数" id="height" name="height" value="" type="text" placeholder="宽度" class="m-wrap span1" />
													</div>
		                                        ...
		                                        <div class="control-group">
													...
													<div class="controls">
														...
														<input dataType="Require" msg="广告名称必须填写" id="ad_name" name="ad_name" value="" type="text" placeholder="广告名称" class="m-wrap span6" />
												...
												<div class="control-group ">
													...
													<div class="controls">
														...
														<input id="link" name="link" value="" type="text" placeholder="点击链接" class="m-wrap span6" />
												...
												<div class="control-group ">
													...
													<div class="controls">
														...
														<div class="basic-toggle-button">
															...
															<input type="checkbox" class="toggle" name="target" value="1" checked="checked" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<div class="input-append date date-picker" >
															...
															<input class="m-wrap m-ctrl-medium date-picker" id="end_time" name="end_time" readonly size="16" type="text" value="" /><span class="add-on" ><i class="icon-calendar"></i></span>
