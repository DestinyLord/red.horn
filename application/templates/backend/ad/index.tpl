							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href="<{site_url uri=$backendDir|cat:'/ad/add'}>" id="sample_editable_1_new" class="btn green">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-480">业务领域</th>

											<th class="hidden-480">页面</th>

											<th class="hidden-480">广告点位</th>

											<th>广告主题</th>

											<th class="hidden-480">广告尺寸</th>
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-480"><{$v.page_name}></td>

											<td class="hidden-480"><{$v.position_name}></td>

											<td><{$v.ad_name}></td>

											<td class="hidden-480"><{$v.width}> * <{$v.height}></td>

											<td class="hidden-480"><{$v.link}></td>

											<td><{$v.end_time|date_format:'%Y-%m-%d %H:%M:%S'}></td>

											<td><{if $v.status == 1}>上线<{else if $v.status == 2}>下回<{/if}></td>
                                                
											<td >
                                                
                                                <{if 'adEdit'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/ad/edit/'|cat:$v.id}>" title="修改">
                                                    <img src="<{$image_path}>icon_edit.gif" alt="修改" />
                                                </a>
                                                <{/if}>
                                                <{if 'adDel'|check_priv}>
                                                <a class=" confirm_opener" href="<{site_url uri=$backendDir|cat:'/ad/delete?id='|cat:$v.id}>" title="删除">
