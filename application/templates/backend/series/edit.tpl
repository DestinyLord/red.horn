									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data">
		                                        <input type="hidden" name="series_id" value="<{$editData.series_id}>" />
													...
													<div class="controls">
														...
														<div class="select2-wrapper">
															...
															<select name="brand_id" class="span6 select2_category" tabindex="1" dataType="Require" msg="品牌必须选择">
																...
																<option <{if $editData.brand_id == 1}>selected="true"<{/if}> value="1">日产</option>
																<option <{if $editData.brand_id == 2}>selected="true"<{/if}> value="2">启辰</option>
																<option <{if $editData.brand_id == 6}>selected="true"<{/if}> value="6">进口</option>
													...
													<div class="controls">
														...
														<div class="select2-wrapper">
															...
															<select name="level" class="span6 select2_category" tabindex="1" dataType="Require" msg="品牌必须选择">
																...
																<option <{if $editData.brand_id == 1}>selected="true"<{/if}> value="1">三厢车</option>
																<option <{if $editData.brand_id == 2}>selected="true"<{/if}> value="2">两厢车</option>
																<option <{if $editData.brand_id == 3}>selected="true"<{/if}> value="3">SUV</option>
																<option <{if $editData.brand_id == 4}>selected="true"<{/if}> value="4">原装进口</option>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input dataType="Require" msg="车系名称必须填写" id="name" name="name" value="<{$editData.name}>" type="text" placeholder="车系名称" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input dataType="Require" msg="车系英文名称必须填写" id="en_name" name="en_name" value="<{$editData.en_name}>" type="text" placeholder="车系英文名称" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="banner_link" name="banner_link" value="<{$editData.banner_link}>" type="text" placeholder="车系首页图链接" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="discount_max" name="discount_max" value="<{$editData.discount_max}>" type="text" placeholder="最大优惠" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="discount_max_pid" name="discount_max_pid" value="<{$editData.discount_max_pid}>" type="text" placeholder="最大优惠车型id" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="discount_min" name="discount_min" value="<{$editData.discount_min}>" type="text" placeholder="最小优惠" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="discount_min_pid" name="discount_min_pid" value="<{$editData.discount_min_pid}>" type="text" placeholder="最小优惠车型id" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="price_min" name="price_min" value="<{$editData.price_min}>" type="text" placeholder="车型最低指导价" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="price_max" name="price_max" value="<{$editData.price_max}>" type="text" placeholder="车型最高指导价" class="m-wrap span6" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="description" name="description" value="<{$editData.description}>" type="text" placeholder="车系简介" class="m-wrap span6" />
												...
												<div class="control-group policyBox">
													...
													<div class="controls">
														<{if $policyList}>
															<{foreach from=$policyList item=policy key='k' name='poli'}>
															<input name="policy[<{$k}>][policy_name]" value="<{$policy.policy_name}>" type="text" placeholder="优惠政策10个字以内" class="m-wrap span4 policy_input policy_name_input" />

															<input name="policy[<{$k}>][policy_name_min]" value="<{$policy.policy_name_min}>" type="text" placeholder="优惠政策短标10个字以内" class="m-wrap span3 policy_input" />

															<input name="policy[<{$k}>][url]" value="<{$policy.url}>" type="text" placeholder="跳转地址" class="m-wrap span3" />
															<img src="<{if $policy.pic_path}>/<{$policy.pic_path}><{else}><{$image_path}>backend/nopic.jpg<{/if}>" width="30" height="30" />
															<input name="pic_path<{$k}>" type="file" class="default" />

															<input name="policy[<{$k}>][pic_path]" value="<{$policy.pic_path}>" type="hidden"/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="rec_index" name="rec_index" value="<{$editData.rec_index}>" type="text" placeholder="排序" class="m-wrap span6" />
											...
											<tbody class="files" data-toggle="modal-gallery" data-target="#modal-gallery">
												...
												<tr class="template-download ">
											        ...
											        <td class="delete">
											            ...
											            <button class="btn red" data-type="GET" data-url="<{site_url uri='backend/series/delImage'}>?id=<{$img.id}>">
