						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
                                    ...
                                    <{if check_priv('seriesAdd')}>
									<!--<div class="btn-group">

										<a href="<{site_url uri=$backendDir|cat:'/series/add'}>" id="sample_editable_1_new" class="btn green">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
                                        ...
                                        <{if $datas}>
                                        <{foreach from=$datas item=v key=k}>
										<tr class="odd gradeX">

											<td><input type="checkbox" class="checkboxes" value="<{$v.series_id}>" /></td>
											<td><{$k+1}></td>
											<td>
                                            <{$v.name}>
                                            </td>

											<td class="hidden-480"><img src="<{$serviceImgUrl|cat:$v.logo}>" width="80" height="60" /></td>

											<td class="hidden-480"><{$v.rec_index}></td>

											<td><{if $v.isactive == 1}>启用<{else if $v.isactive == 0}>禁用<{else if $v.isactive == 2}>下线<{/if}></td>
                                                
											<td >
                                                
                                                <{if 'seriesEdit'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/series/edit/'|cat:$v.series_id}>" title="修改">
                                                    修改
                                                </a>
                                                <{/if}>
                                                <{if 'seriesDel'|check_priv}>
                                                <a class=" confirm_opener" href="<{site_url uri=$backendDir|cat:'/series/delete?series_id='|cat:$v.series_id}>" title="删除">
                                                    删除
                                                </a>
                                                <{/if}>
                                            </td>
