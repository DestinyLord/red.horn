								...
								<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Require" msg="活动名称必须填写" id="activity_name" name="activity_name" value="<{$editData.activity_name}>" type="text" placeholder="活动名称" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Number" msg="期数必须为正整数" id="number" name="number" value="<{$editData.number}>" type="text" placeholder="期数" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Number" msg="参与人数必须为正整数" id="join_num" name="join_num" value="<{$editData.join_num}>" type="text" placeholder="参与人数" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<div class="input-append date date-picker" >
												...
												<input dataType="Require" msg="活动时间必须填写" class="m-wrap m-ctrl-medium date-picker" id="start_time" name="start_time" readonly size="16" type="text" value="<{$editData.start_time|date_format:'%Y-%m-%d'}>" placeholder="开始时间" /><span class="add-on" ><i class="icon-calendar"></i></span>

											</div>

											<div class="input-append date date-picker" >

												<input dataType="Require" msg="活动时间必须填写" class="m-wrap m-ctrl-medium date-picker" id="end_time" name="end_time" readonly size="16" type="text" value="<{$editData.end_time|date_format:'%Y-%m-%d'}>" placeholder="结束时间" /><span class="add-on" ><i class="icon-calendar"></i></span>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<div class="input-append date date-picker" >
												...
												<input dataType="Require" msg="揭晓时间必须填写" class="m-wrap m-ctrl-medium date-picker" id="draw_time" name="draw_time" readonly size="16" type="text" value="<{$editData.draw_time|date_format:'%Y-%m-%d'}>" placeholder="揭晓时间" /><span class="add-on" ><i class="icon-calendar"></i></span>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Number" msg="参与人数必须为正整数" id="price" name="price" value="<{$editData.price}>" type="text" placeholder="参与人数" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Require" msg="订单号码必须填写" id="order_num" name="order_num" value="<{$editData.order_num}>" type="text" placeholder="订单号码" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Require" msg="客户姓名必须填写" id="win_name" name="win_name" value="<{$editData.win_name}>" type="text" placeholder="客户姓名" class="m-wrap span6" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="Require" msg="手机号码必须填写" id="tel" name="tel" value="<{$editData.tel}>" type="text" placeholder="手机号码" class="m-wrap span6" />
											...
											<div class="select2-wrapper">
												...
												<select name="series_id" class="span6 select2_category" dataType="Require" msg="车型必须选择">
													...
													<option value="">请选择车型</option>
                                                  	...
                                                  	<option <{if $editData.series_id == $v.series_id}>selected="true"<{/if}> value="<{$v.series_id}>"><{$v.name}></option>
                                                  	<{/foreach}>
											...
											<div class="select2-wrapper">
												...
												<select name="dealer_id" class="span6 select2_category" dataType="Require" msg="专营店必须选择">
													...
													<option value="">请选择专营店</option>
                                                  	...
                                                  	<option <{if $editData.dealer_id == $v.dealer_id}>selected="true"<{/if}> value="<{$v.dealer_id}>"><{$v.dealer_name_short}></option>
                                                  	<{/foreach}>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input dataType="IdCard" msg="身份证号码格式错误" id="idcard_no" name="idcard_no" value="<{$editData.idcard_no}>" type="text" placeholder="身份证号码" class="m-wrap span6" />
									...
									<div class="control-group last">
										...
										<div class="controls">
											...
											<input dataType="Require" msg="KEY值必须填写" id="leads_key" name="leads_key" value="<{$editData.leads_key}>" type="text" placeholder="KEY值" class="m-wrap span6" />
