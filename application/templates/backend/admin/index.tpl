						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
                                    ...
                                    <{if check_priv('adminUserAdd')}>
									<div class="btn-group">

										<a href="<{site_url uri=$backendDir|cat:'/admin/add'}>" id="sample_editable_1_new" class="btn green">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-480"><{$v.role_name}></td>

											<td class="hidden-480"><{$v.hits}></td>

											<td class="center hidden-480"><{$v.last_login_time|date_format:'%Y-%m-%d %H:%M:%S'}></td>
                                                
											<td >
                                                <{if 'assignPriv'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/permission/assignPriv/admin_user/'|cat:$v.id}>" title="分派权限">
                                                    <img src="<{$image_path}>icon_priv.gif" alt="分派权限" />
                                                </a>
                                                <{/if}>
                                                <{if 'adminUserEdit'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/admin/edit/'|cat:$v.id}>" title="修改">
                                                    <img src="<{$image_path}>icon_edit.gif" alt="修改" />
                                                </a>
                                                <{/if}>
                                                <{if 'adminUserDel'|check_priv}>
                                                <a class=" confirm_opener" href="<{site_url uri=$backendDir|cat:'/admin/delete?id='|cat:$v.id}>" title="删除">
