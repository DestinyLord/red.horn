							...
							<div class="portlet box blue ">
								...
								<div class="portlet-body form">
									...
									<form id="dataform" action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form" enctype="multipart/form-data" >
                                        ...
                                        <input type="hidden" id="oldImg" name="oldImg" value="<{$info.main_picture}>" />
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input dataType="Require" msg="活动主题必须填写" id="activity_name" name="activity_name" value="<{$info.activity_name}>" type="text" placeholder="活动主题" class="m-wrap span6" />
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												...
												<input  dataType="Require" msg="团购地点必须填写" id="activety_addr" name="activety_addr" value="<{$info.activety_addr}>" type="text" placeholder="团购地点" class="m-wrap span6" />
												...
												<{foreach from=$seriesList item=seriesData name=sl}>
													...
													<{/if}>
														<div class="span3">
															...
															<input type="checkbox" <{if in_array($seriesData.series_id ,$info.series_id )}>checked="true"<{/if}> name="series_id[]" value="<{$seriesData.series_id}>" /> <{$seriesData.name}>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input dataType="Require" msg="团购已报名基数必须填写" id="apply_user" name="apply_user" value="<{$info.apply_user}>" type="text" placeholder="团购已报名基数" class="m-wrap span6" />
											...
											<div class="controls">
												...
												<div class="fileupload fileupload-new" data-provides="fileupload">
													...
													<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
														...
														<img src="<{if $info.main_picture}><{base_url uri=$info.main_picture}><{else}><{$image_path}>backend/nopic.jpg<{/if}>" alt="" />
												...
												上传功能只支持Firefox、Chrome,Opera,Safari和ie10或以上浏览器
