                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        <{if check_priv('VIPDealerCarAdd')}>
                                        <a href="<{site_url uri=$backendDir|cat:'/vipdealer/addCar'}>" id="sample_editable_1_new" class="btn green" style="margin-right:10px;">

                                        添加一口价车 <i class="icon-plus"></i>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <{if check_priv('VIPDealerCarEdit')}>
                                                <a href="<{site_url uri=$backendDir|cat:'/vipdealer/editCar/'|cat:$v.id}>">编辑</a>
                                                <{if $v.status==1 && $v.end_time > time()}>
                                                &nbsp;&nbsp;<a target="_blank" href="https://df.shopmodule.jaeapp.com/index.php/active/specialCar/<{$v.series_id}>?city_id=<{$v.dealer_city}>">预览</a>
                                                &nbsp;&nbsp;
                                                <img src="/uploads/images/QRCode/vipdealerCar/<{$v.id}>.png" width="80" height="80" />
                                                <{/if}>
                                                <{/if}>
                                            </td>
