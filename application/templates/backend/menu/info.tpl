									...
									<form action="<{$formAction}>" method="post" class="form-horizontal form-bordered info-form">
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												...
												<input id="menu_title" name="menu_title" value="<{if $editData}><{$editData.menu_title}><{/if}>" type="text" placeholder="Menu Title" class="m-wrap span12" />
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												...
												<input name="menu_url" value="<{if $editData}><{$editData.menu_url}><{/if}>" type="text" placeholder="Menu URL" class="m-wrap span12" />
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												...
												<input name="icon_class" value="<{if $editData}><{$editData.icon_class}><{/if}>" type="text" placeholder="ICON Class" class="m-wrap span12" />
                                        ...
                                        <div class="control-group last">
											...
											<div class="controls">
												...
												<input name="seqorder" value="<{if $editData}><{$editData.seqorder}><{else}>0<{/if}>" type="text" placeholder="Order" class="m-wrap span12" />
