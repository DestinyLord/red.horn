					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
                                    <{if 'menuAdd'|check_priv}>
									<div class="btn-group">
                                        
										<a href="<{site_url uri=$backendDir|cat:'/menu/add'}>" id="sample_editable_1_new" class="btn green">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-480"><{$v.menu_url}></td>

											<td class="hidden-480"><{$v.seqorder}></td>

											<td class="center hidden-480"><div class="<{$v.icon_class}>"></div></td>

											<td >
                                                <{if 'menuEdit'|check_priv}>
                                                <a href="<{site_url uri=$backendDir|cat:'/menu/edit/'|cat:$v.id}>" title="修改">
                                                    <img src="<{$image_path}>icon_edit.gif" alt="修改" />
                                                </a>
                                                <{/if}>
                                                <{if 'menuDel'|check_priv}>
                                                <a class="confirm_opener" href="<{site_url uri=$backendDir|cat:'/menu/delete?id='|cat:$v.id}>" title="删除">
